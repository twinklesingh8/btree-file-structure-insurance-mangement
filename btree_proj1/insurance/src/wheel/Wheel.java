...
public void insert(int key)
	{
		...
		promote(leaf,key,null);
		 System.out.print("---------------\n");
		try{  
                     File fle = new File("C:\\Users\\User\\OneDrive\\Documents\\btree_proj1\\traverse.txt");
		  ...
		  System.out.print("---------------- \n");
                  try{ 
                      FileWriter fw=new FileWriter("C:\\Users\\User\\OneDrive\\Documents\\btree_proj1\\traverse.txt",true);
                        fw.write("-----------------\n");
                        fw.close();
                    }
                    catch(Exception e)
...
void traverse(node ptr){
                 ...
                 for(int i = 0; i < ptr.size; i++)
                {
                  ...
                  try{  FileWriter fw=new FileWriter("C:\\Users\\User\\OneDrive\\Documents\\btree_proj1\\traverse.txt",true);
                    fw.write(ptr.a[i]+" ");
                    fw.close();
                }
...
no1=0;
try {
          File fle = new File("C:\\Users\\User\\OneDrive\\Documents\\btree_proj1\\orders.txt");
          if (fle.createNewFile()){
            System.out.println("File is created!");
            }else{
            System.out.println("File already exists.");
...
BufferedReader reader = new BufferedReader(new FileReader("C:\\Users\\User\\OneDrive\\Documents\\btree_proj1\\orders.txt"));
String line;
